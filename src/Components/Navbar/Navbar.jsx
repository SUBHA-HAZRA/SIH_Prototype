        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20">
            ...
            <div className="hidden md:flex items-center gap-3 lg:gap-4">
              ...
              {/* User Avatar instead of Login */}
              <img
                src="https://thumbs.dreamstime.com/b/default-avatar-profile-vector-user-profile-default-avatar-profile-vector-user-profile-profile-179376714.jpg?w=768"
                alt="User Avatar"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="flex flex-col py-4 space-y-1">
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  <div
                    className={`flex items-center gap-3 text-gray-700 font-medium hover:text-blue-600 cursor-pointer transition-all duration-300 px-4 py-3 rounded-lg hover:bg-blue-50 transform ${
                      menuOpen
                        ? "translate-x-0 opacity-100"
                        : "translate-x-4 opacity-0"
                    }`}
                  ...
                  <div
                    className={`flex items-center gap-3 px-4 py-2 transform transition-all duration-300 ${
                      menuOpen
                        ? "translate-x-0 opacity-100"
                        : "translate-x-4 opacity-0"
                    }`}
